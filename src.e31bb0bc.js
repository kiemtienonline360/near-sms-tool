...
},{"bn.js":"../node_modules/bn.js/lib/bn.js","bs58":"../node_modules/bs58/index.js","text-encoding-utf-8":"../node_modules/text-encoding-utf-8/lib/encoding.lib.js","buffer":"../node_modules/node-libs-browser/node_modules/buffer/index.js"}],"../node_modules/near-api-js/lib/utils/serialize.js":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"depd":"../node_modules/depd/lib/browser/index.js","./provider":"../node_modules/near-api-js/lib/providers/provider.js","../utils/web":"../node_modules/near-api-js/lib/utils/web.js","../utils/errors":"../node_modules/near-api-js/lib/utils/errors.js","borsh":"../node_modules/borsh/lib/index.js","../utils/exponential-backoff":"../node_modules/near-api-js/lib/utils/exponential-backoff.js","../utils/rpc_errors":"../node_modules/near-api-js/lib/utils/rpc_errors.js","buffer":"../node_modules/node-libs-browser/node_modules/buffer/index.js"}],"../node_modules/near-api-js/lib/providers/index.js":[function(require,module,exports) {
"use strict";
/** @hidden @module */
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"bn.js":"../node_modules/bn.js/lib/bn.js","depd":"../node_modules/depd/lib/browser/index.js","./transaction":"../node_modules/near-api-js/lib/transaction.js","./providers":"../node_modules/near-api-js/lib/providers/index.js","borsh":"../node_modules/borsh/lib/index.js","./utils/key_pair":"../node_modules/near-api-js/lib/utils/key_pair.js","./utils/errors":"../node_modules/near-api-js/lib/utils/errors.js","./utils/rpc_errors":"../node_modules/near-api-js/lib/utils/rpc_errors.js","./utils/exponential-backoff":"../node_modules/near-api-js/lib/utils/exponential-backoff.js","buffer":"../node_modules/node-libs-browser/node_modules/buffer/index.js"}],"../node_modules/near-api-js/lib/account_multisig.js":[function(require,module,exports) {
var Buffer = require("buffer").Buffer;
'use strict';
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
...
},{"depd":"../node_modules/depd/lib/browser/index.js","./account":"../node_modules/near-api-js/lib/account.js","./transaction":"../node_modules/near-api-js/lib/transaction.js","./utils":"../node_modules/near-api-js/lib/utils/index.js","borsh":"../node_modules/borsh/lib/index.js","buffer":"../node_modules/node-libs-browser/node_modules/buffer/index.js"}],"../node_modules/near-api-js/lib/common-index.js":[function(require,module,exports) {
"use strict";
var __createBinding = (this && this.__createBinding) || (Object.create ? (function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    Object.defineProperty(o, k2, { enumerable: true, get: function() { return m[k]; } });
...
var CONTRACT_NAME = "dev-1629591474127-44284105191428" || 'dev-1629591474127-44284105191428';
  ...
  switch (env) {
    ...
    case 'local':
      return {
        ...
        keyPath: "".concat("C:\\Users\\DELL", "/.near/validator_key.json"),
...
var near = null; // Initialize contract & set global variables
...
function isAccountExist(_x) {
  return _isAccountExist.apply(this, arguments);
}

function _isAccountExist() {
  _isAccountExist = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(accountId) {
    var ret;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 1;
            _context2.next = 4;
            return near.connection.provider.query("account/".concat(accountId), "");
...
document.querySelector('form').onsubmit = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(event) {
    var _event$target$element, toAccount, title, content;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _event$target$element = event.target.elements, toAccount = _event$target$element.toAccount, title = _event$target$element.title, content = _event$target$element.content; // Check input
          ...
          case 14:
            _context.next = 16;
            return (0, _utils.isAccountExist)(toAccount.value);
          ...
          case 16:
            ...
            alert("The account '".concat(toAccount.value, "' is not existed. Please enter the other account!"));
            return _context.abrupt("return");

          case 19:
            // disable the save button, since it now matches the persisted value
            submitButton.disabled = true; // send message

            _context.next = 22;
            return sendMessage(toAccount.value, title.value, content.value);

          case 22:
            // reset message box
            resetNewMsgBox(); // show notification
            ...
            }, 11000); // update the messages in the UI
...
document.querySelector('input#toAccount').oninput = function (event) {
  checkSubmitButton();
};

document.querySelector('input#title').oninput = function (event) {
  checkSubmitButton();
};

document.querySelector('textarea#content').oninput = function (event) {
  checkSubmitButton();
}; // Handle user action events


document.querySelector('#sign-in-button').onclick = _utils.login;
document.querySelector('#sign-out-button').onclick = _utils.logout; // Check user input to enable/disable submit button

function checkSubmitButton() {
  var value1 = document.querySelector('input#toAccount').value;
  var value2 = document.querySelector('input#title').value;
  var value3 = document.querySelector('textarea#content').value;
...
function updateWidthForDivColumn2() {
  var obj = document.querySelector('.div-column2');
  var width = document.getElementById("signed-in-flow").clientWidth;
...
function _sendMessage() {
  _sendMessage = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(toAccount, title, content) {
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
...
function updateAppUI() {
  return _updateAppUI.apply(this, arguments);
}

function _updateAppUI() {
  _updateAppUI = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 10:
            if (!(appInfo.currentMenu == "COMPOSE")) {
              _context3.next = 13;
              break;
            }

            _context3.next = 13;
            return updateComposeUI();
...
function updateInboxUI() {
  return _updateInboxUI.apply(this, arguments);
}

function _updateInboxUI() {
  _updateInboxUI = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
    var inboxMsgNum, inboxMessages, indexInfo;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            document.querySelector('#newMsgBoard').style.display = 'none'; // Update title

            document.querySelector('#bodyTitle').innerText = "Inbox";
            document.querySelector('#bodyTitleInfo').innerText = "";
            document.querySelector('#pagingInfo').innerHTML = ""; // Fetch inbox messages and show messages to UI

            _context4.next = 8;
            return contract.getInboxMsgNum({
              accountId: window.accountId
            });

          case 8:
            inboxMsgNum = _context4.sent;
            inboxMessages = [];
            indexInfo = getIndexInfo(inboxMsgNum, appInfo.inbox.currentPage, appInfo.itemPerPage);
            ...
            _context4.next = 14;
            return contract.getInboxMessages({
              accountId: window.accountId,
...
function updateSentUI() {
  return _updateSentUI.apply(this, arguments);
} // Sort messages so that recent messages show first


function _updateSentUI() {
  _updateSentUI = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
    var sentMsgNum, sentMessages, indexInfo;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            document.querySelector('#bodyTitleInfo').innerText = "";
            document.querySelector('#pagingInfo').innerHTML = ""; // Fetch sent messages and show messages to UI

            _context5.next = 8;
            return contract.getSentMsgNum({
              accountId: window.accountId
            });

          case 8:
            sentMsgNum = _context5.sent;
            sentMessages = [];
            indexInfo = getIndexInfo(sentMsgNum, appInfo.sent.currentPage, appInfo.itemPerPage);
            ...
            _context5.next = 14;
            return contract.getSentMessages({
              accountId: window.accountId,
              fromIndex: indexInfo.fromIndex,
              toIndex: indexInfo.toIndex
            });
...
function getPageLinkStr(type, msgNum) {
  var page = "Page: ";
  var currentPage = appInfo[type].currentPage;
  var pageNum = 0;
  ...
  for (var idx = 1; idx <= pageNum; idx++) {
    if (idx == currentPage) {
      page += "".concat(idx, " ");
    } else {
      page += "<a href=\"#\" onclick=\"onPageChange('".concat(type, "', ").concat(idx, ");\">").concat(idx, "</a> ");
    }
  }
...
function showSentMessages(sentMsgNum, sentMessages) {
  ...
  var fromPosition = (appInfo.sent.currentPage - 1) * appInfo.itemPerPage + 1;
  var toPosition = fromPosition + sentMessages.length - 1;

  if (fromPosition <= toPosition) {
    document.querySelector('#bodyTitleInfo').innerText = "(".concat(fromPosition, "-").concat(toPosition, "/").concat(sentMsgNum, ")");
  } else {
    document.querySelector('#bodyTitleInfo').innerText = "";
  } // Show sent items
  ...
  for (var idx = 0; idx < sentMessages.length; idx++) {
    ...
    var itemHtml = "<div id=\"sentMsg-".concat(idx, "\" class=\"msgItem").concat(idx % 2, "\">");
    itemHtml += "<b>To:</b> ".concat(msg.to);
    itemHtml += "<br /><b>Time:</b> ".concat(new Date(msg.timestamp / Math.pow(10, 6)).toLocaleString());
    itemHtml += "<br /><b>Title:</b> ".concat(msg.title);
    itemHtml += "<br /><b>Content:</b>";
    itemHtml += "<br />".concat(msg.content);
    itemHtml += "</div>";
    html += itemHtml;
  }
...
function showInboxMessages(inboxMsgNum, inboxMessages) {
  // Show number of items
  var fromPosition = (appInfo.inbox.currentPage - 1) * appInfo.itemPerPage + 1;
  var toPosition = fromPosition + inboxMessages.length - 1;

  if (toPosition >= fromPosition) {
    document.querySelector('#bodyTitleInfo').innerText = "(".concat(fromPosition, "-").concat(toPosition, "/").concat(inboxMsgNum, ")");
  } else {
    document.querySelector('#bodyTitleInfo').innerText = "";
  } // Show inbox items
  ...
  for (var idx = 0; idx < inboxMessages.length; idx++) {
    ...
    var itemHtml = "<div id=\"inboxMsg-".concat(idx, "\" class=\"msgItem").concat(idx % 2, "\">");
    itemHtml += "<b>From:</b> ".concat(msg.from);
    itemHtml += "<br /><b>Time:</b> ".concat(new Date(msg.timestamp / Math.pow(10, 6)).toLocaleString());
    itemHtml += "<br /><b>Title:</b> ".concat(msg.title);
    itemHtml += "<br /><b>Content:</b>";
    itemHtml += "<br />".concat(msg.content);
...
function updateComposeUI() {
  return _updateComposeUI.apply(this, arguments);
}

function _updateComposeUI() {
  _updateComposeUI = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            document.querySelector('#inboxMessages').style.display = 'none';
            document.querySelector('#sentMessages').style.display = 'none';
            document.querySelector('#newMsgBoard').style.display = 'block'; // Update title

            document.querySelector('#bodyTitle').innerText = "Compose new message";
            document.querySelector('#bodyTitleInfo').innerText = "";
            document.querySelector('#pagingInfo').innerHTML = ""; // Update statics
...
function updateStaticInfoUI() {
  return _updateStaticInfoUI.apply(this, arguments);
} // `nearInitPromise` gets called on page load


function _updateStaticInfoUI() {
  _updateStaticInfoUI = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
    var staticsInfo;
    return regeneratorRuntime.wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            _context7.next = 2;
            return contract.getStatics();

          case 2:
            staticsInfo = _context7.sent;
            ...
            document.querySelector('#staticsInfo').innerHTML = "<b>Statics</b>: ".concat(staticsInfo.sentAccountNum, " used accounts, ").concat(staticsInfo.accountNum, " total accounts and ").concat(staticsInfo.messageNum, " messages");
